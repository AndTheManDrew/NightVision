        ...
        public static class HarmonyPatches
            {
                ...
                static HarmonyPatches()
                    {
                        HarmonyInstance harmony = HarmonyInstance.Create("nightvision.rimworld.mod");
                        ...
                        harmony.Patch(
                            ...
                            null,
                            new HarmonyMethod(typeof(HarmonyPatches), nameof(MechanoidsFixerAncient)));
                        ...
                        harmony.Patch(
                            typeof(CompSpawnerMechanoidsOnDamaged)
                                        ...
                                        .First(mi => mi.HasAttribute<CompilerGeneratedAttribute>()
                                                     ...
                                                     && mi.GetParameters()[0].ParameterType == typeof(PawnKindDef)),
                            null,
                            new HarmonyMethod(typeof(HarmonyPatches), nameof(MechanoidsFixer)));
                        //Pawn
                        harmony.Patch(Pawn_getBodySize,
                            null,
                            new HarmonyMethod(typeof(HarmonyPatches), nameof(GetBodySize_Patch)));
