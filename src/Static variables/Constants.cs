        ...
        public static class Constants
            {
                ...
                public static readonly string FullMultiLabel =
                            "NVFullLabel".Translate() + " = x{0:##}%";

                public const float  IndicatorSize  = 12f;
                public const float  MaxGlowNoGlow  = 0.7f;
                public const string Maxline        = " ({0}{1}:{2,6:+#0%;-#0%;+0%})";
                public const float  MinGlowNoGlow  = 0.3f;
                public const string ModifierLine   = "{0}:{1,6:+#0%;-#0%;0%}";
                public const string MultiplierLine = "{0}:{1,6:x#0%;x#0%;x0%}";
                ...
                public static readonly string  ZeroLabel        = "NVZeroLabel".Translate() + " = {0:+#;-#;0}%";
