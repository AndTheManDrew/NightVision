...
namespace NightVision
{
    ...
    public static class PawnGeneratorNV
    {
        ...
        {
            Traverse menuTraverse = Traverse.Create(__instance);
                    ...
                    for (int i = 0; i < 4; i++)
                    {
                        ...
                        list3.Add(
                            new DebugMenuOption(
                                ...
                                delegate
                                {
                                    List<DebugMenuOption> listAB = new List<DebugMenuOption>();

                                    foreach (var ab in ABShoot)
                                    {
                                        listAB.Add(
                                            new DebugMenuOption(
                                                ab.label,
                                                ...
                                                delegate
                                                {
                                                    ...
                                                    list4.Add(
                                                        new DebugMenuOption(
                                                            ...
                                                            delegate
                                                            {
                                                                SpawnPawn(skill, ab, null, false, SkillDefOf.Shooting);
                                                            }
                                                        )
                                                    );

                                                    foreach (var hediffDef in Storage.HediffLightMods)
                                                    {
                                                        ...
                                                        list4.Add(
                                                            new DebugMenuOption(
                                                                ...
                                                                delegate
                                                                {
                                                                    SpawnPawn(skill, ab, nvhediff, hediffMods.AffectsEye, SkillDefOf.Shooting);
                                                                }
                                                            )
                                                        );
                                                    }
                                    ...
                                    Find.WindowStack.Add(new Dialog_DebugOptionListLister(listAB));
                                }
                            )
                        );
                    }
                                                ...
                                                delegate
                                                {
                                                    ...
                                                    list4.Add(
                                                        new DebugMenuOption(
                                                            ...
                                                            delegate
                                                            {
                                                                SpawnPawn(skill, ab, null, false, SkillDefOf.Melee);
                                                            }
                                                        )
                                                    );
                                                    ...
                                                    foreach (var hediffDef in Storage.HediffLightMods)
                                                    {
                                                        ...
                                                        list4.Add(
                                                            new DebugMenuOption(
                                                                ...
                                                                delegate
                                                                {
                                                                    SpawnPawn(skill, ab, nvhediff, hediffMods.AffectsEye, SkillDefOf.Melee);
                                                                }
                                                            )
                                                        );
                                                    }
            ...
            menuTraverse.Method(
                ...
                (Action) delegate
                {
                    PerformBattleRoyale(SkillDefOf.Melee);
                }
            ).GetValue();
            menuTraverse.Method(
                "DebugAction",
                "NightVision: Battle Royale Shooting",
                (Action) delegate
                {
                    PerformBattleRoyale(SkillDefOf.Shooting);
                }
            ).GetValue();
        }
        ...
        private static void SpawnPawn(int skill, AorB ab, HediffDef hediffs, bool AffectsEye, SkillDef skilldef)
        {
            ...
            if (hediffs != null)
            {
                if (AffectsEye)
                {
                    foreach (var bpr in newPawn.RaceProps.body.GetPartsWithTag(Constants.EyeTag))
                    {
