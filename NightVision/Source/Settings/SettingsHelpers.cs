...
namespace NightVision
    {
        internal static class SettingsHelpers
            {
                public static Dictionary<Def, string> _tipStringHolder;
                ...
                public static float ModToMultiPercent(
                    float mod,
                    bool  isZeroLight) =>
                            (float) Math.Round(100f * (mod + (isZeroLight
                ...
                public static float MultiPercentToMod(
                    float multipercent,
                    bool  isZeroLight) =>
                            (float) Math.Round(multipercent / 100f, 2) - (isZeroLight
                                        ? Constants.DefaultZeroLightMultiplier
                                        : Constants.DefaultFullLightMultiplier);
                ...
                public static void DrawIndicator(
                    ...
                    Texture2D indicator)
                    {
                        ...
                        rowRect.position = new Vector2(posOfDefault - 0.5f * Constants.IndicatorSize,
                                ...
                                if (hediffMods.AutoAssigned)
                                         ...
                                         || Math.Abs(lightModifiers.DefaultOffsets[1]) > 0.001f)
                                    {
                                        result += "\n" + "NVLoadedFromFile".Translate(
                                                      Hediff_LightModifiers.GetSetting(hediffMods),
                        ...
                        if (lightMods.IsCustom())
                            {
                                ...
                                var zeroModAsPercent = (float) Math.Round(
                                    (lightMods.Offsets[0] + (isRace ? Constants.DefaultZeroLightMultiplier : 0)) * 100);
                                var fullModAsPercent = (float) Math.Round(
                                    (lightMods.Offsets[1] + (isRace ? Constants.DefaultFullLightMultiplier : 0)) * 100);
                                ...
                                if (isRace)
                                    {
                                        ...
                                        zeroModAsPercent = Widgets.HorizontalSlider(topRect,
                                            ...
                                            max,
                                            true,
                                            string.Format(Constants.ZeroMultiLabel, zeroModAsPercent),
                                        ...
                                        fullModAsPercent = Widgets.HorizontalSlider(bottomRect,
                                            ...
                                            max,
                                            true,
                                            string.Format(Constants.FullMultiLabel, fullModAsPercent),
                                            string.Format(Constants.XLabel,         min),
                                            string.Format(Constants.XLabel,         max),
                                            1);
                                ...
                                else
                                    {
                                        ...
                                        zeroModAsPercent = Widgets.HorizontalSlider(topRect,
                                            ...
                                            string.Format(Constants.Alabel,    SettingsCache.MinCache - 80),
                                            string.Format(Constants.Alabel,    SettingsCache.MaxCache - 80),
                                            1);
                                        ...
                                        fullModAsPercent = Widgets.HorizontalSlider(bottomRect,
                                            ...
                                            string.Format(Constants.Alabel,    SettingsCache.MinCache - 100),
                                            string.Format(Constants.Alabel,    SettingsCache.MaxCache - 100),
                                            1);
