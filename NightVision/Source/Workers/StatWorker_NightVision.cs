                                        ...
                                        foreach (Apparel app in comp.PawnsNVApparel ?? Enumerable.Empty<Apparel>())
                                            {
                                                if (Storage.NVApparel.TryGetValue(app.def,
                                                        out ApparelVisionSetting setting) && setting.GrantsNV)
                                                    {
                        ...
                        if (optionalReq.HasThing)
                            {
                                ...
                                if (optionalReq.Thing is Apparel apparel
                                    && Storage.NVApparel.TryGetValue(apparel.def,
                                        out ApparelVisionSetting apparelSetting) && apparelSetting.GrantsNV)
                                    {
